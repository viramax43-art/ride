...
import { Car, CaretLeft, CaretRight, CreditCard, Gear, MapPin, PenNib, Plus, UserCircle, Users, X } from '@phosphor-icons/react'
...
const TAB_DEFS = [
  ...
  { id: 'passengers' as AdminTab, icon: UserCircle, labelKey: 'admin.tabs.passengers' },
    ...
    <>
      ...
      >
        ...
        {!collapsed && (
          <button
            onClick={onToggleCollapse}
            className="flex absolute top-1/2 -right-4 z-[1001] w-9 h-9 bg-white border border-border rounded-full shadow-card items-center justify-center hover:bg-surface transition-colors"
              ...
              >
                ...
                <span
                  className={`font-medium leading-none whitespace-nowrap ${
                    tab.id === 'passengers'
                      ? 'text-[8px] tracking-[-0.04em] scale-[0.72] origin-center'
                      : 'text-[9px]'
                  }`}
                >
                  {t(tab.labelKey)}
          ...
          <div className="px-5 py-4 border-b border-border flex items-center justify-between flex-shrink-0">
            <div>
              ...
              <p className="text-[11px] text-muted mt-0.5">
                ...
                {activeTab === 'passengers' && t('admin.sidebar.passengersCount', { count: passengersTotal })}
